          ...
          <Row className="header-box d-flex align-items-center">
            <Col lg="6">
              <h1 className="mb-4 animate__animated animate__fadeInUp animate__delay-1s">
                Temukan <br /> <span>Bakat kreatifmu</span> Besama Kami
              </h1>
              <p className="mb-4 animate__animated animate__fadeInUp animate__delay-1s">
                Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                Delectus fugiat obcaecati vel nemo dolor minima totam laborum
                eum cupiditate? Nisi iste dolores dolorem numquam officia
                assumenda nemo quam eum itaque?
              </p>
              <button
          ...
          <Row>
            <Col>
              ...
              <p className="text-center">
                Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                Doloremque possimus quisquam ad ratione nam hic deleniti neque,
                officia facilis cum voluptatibus ea dicta officiis in blanditiis
                mollitia minus quod dolores!
              </p>
            </Col>
          </Row>
